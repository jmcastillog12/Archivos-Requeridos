...
# Load data from csv
def load_data():
    # Leer el archivo CSV   # To do: Completar la función
...
def description_card():
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                id="intro",
                children="Comentario Ajustado: Esta herramienta contiene información sobre la demanda energética total en Austria cada hora según lo públicado en ENTSO-E Data Portal. Adicionalmente, permite realizar pronósticos hasta 5 dias en el futuro."
            ),
        ],
    )
